"""Embedding generation module using Cohere embeddings."""
...
def get_embeddings() -> CohereEmbeddings:
    """Get cached Cohere embeddings instance.
...
class EmbeddingService:
    ...
    # for data ingestion, we will use embed_documents to generate embeddings for multiple documents at once
